...
class Processor(DataProcessor):
    ...
    def _create_examples(self, input_data, history_len,dataset_type = None, use_gpt = False, attention = False):
        ...
        # AC: change "span_start" and "span_end". rationale not contiguous   use _datum['annotated_context']['sentences'], _datum['raw_context_offsets'] and _datum['supporting_facts']
